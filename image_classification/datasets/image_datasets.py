...
def build_image_dataset(args):
    ...
    if args.dataset == 'imagenet':
        ...
        dataset_train = datasets.ImageFolder(f'{args.data_path}/imagenet-r/train/', transform=transform_train)
        dataset_val = datasets.ImageFolder(f'{args.data_path}/imagenet-r/test/', transform=transform_val)
