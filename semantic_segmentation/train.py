...
import models.swin_parax  # noqa: F401
import models.convnext_parax  # noqa: F401
...
def parse_args():
    ...
    parser.add_argument('--batch-size', type=int, default=-1,
                        help='batch size during training, -1 denotes using the value in config')
    parser.add_argument(
        '--no-validate',
        action='store_true',
    ...
    parser.add_argument(
        ...
        default=-1,
        type=float,
        help='learning rate of the optimizer, -1 denotes using the value in config')
    parser.add_argument(
        '--freeze-bn',
        action='store_true',
        default=False,
...
def main():
    ...
    if args.batch_size > 0:
        try:
            ...
            logger.info('batch_size is not defined in the config file')  
    ...
    if args.lr > 0:
        try:
            ...
            logger.info('lr is not defined in the config file')      
